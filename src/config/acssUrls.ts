...
export const ACSS_CONTRACT_URLS: ACSSContractURL[] = [
  ...
  { ulsCode: 'ULS_PV', ulsNome: 'ULS Povoa de Varzim-Vila do Conde', validado: false, observacoes: 'PDF nao encontrado — slug desconhecido' },
  { ulsCode: 'ULS_GE', ulsNome: 'ULS Gaia/Espinho', validado: false, observacoes: 'PDF nao encontrado — slug desconhecido' },
  ...
  { ulsCode: 'ULS_TMAD', ulsNome: 'ULS Tras-os-Montes e Alto Douro', validado: false, observacoes: 'PDF nao encontrado — slug desconhecido' },
  // Centro — 8 ULS
  ...
  { ulsCode: 'ULS_CB', ulsNome: 'ULS Castelo Branco', validado: false, observacoes: 'PDF nao encontrado — slug desconhecido' },
  ...
  { ulsCode: 'ULS_ET', ulsNome: 'ULS Estuario do Tejo', validado: false, observacoes: 'PDF nao encontrado — slug desconhecido' },
  { ulsCode: 'ULS_AR', ulsNome: 'ULS Arco Ribeirinho', validado: false, observacoes: 'PDF nao encontrado — slug desconhecido' },
