/**
 * Systematic mapping of 54 PETS measures to public datasets.
 * Sources: Transparencia SNS (140 datasets), dados.gov.pt (ACSS/SPMS/MS)
...
export interface MeasureDataMapping {
  ...
  crossRefIds?: string[];
  dataAvailability: 'api_mensal' | 'dados_fixos' | 'sem_dados';
}

export const MEASURE_DATA_MAPPINGS: MeasureDataMapping[] = [
  // ═══ EIXO 1 ═══
  { medidaId: 'E1.A1', eixo: 1, primaryDataset: { portal: 'transparencia_sns', slug: 'intervencoes-cirurgicas', campoValor: 'no_intervencoes_cirurgicas_programadas', campoPeriodo: 'tempo', campoInstituicao: 'instituicao', invertido: false, unidade: 'cirurgias' }, crossRefIds: ['CR_LIC_TMRG'], dataAvailability: 'api_mensal' },
  ...
  { medidaId: 'E1.B2', eixo: 1, dataAvailability: 'dados_fixos' },
  ...
  // ═══ EIXO 3 ═══
  { medidaId: 'E3.A1', eixo: 3, dataAvailability: 'dados_fixos' },
  { medidaId: 'E3.A2', eixo: 3, dataAvailability: 'dados_fixos' },
  ...
  { medidaId: 'E4.A2', eixo: 4, dataAvailability: 'dados_fixos' },
  ...
  { medidaId: 'E4.B1', eixo: 4, dataAvailability: 'dados_fixos' },
  ...
  // ═══ EIXO 5 ═══
  { medidaId: 'E5.A1', eixo: 5, primaryDataset: { portal: 'transparencia_sns', slug: 'trabalhadores-por-grupo-profissional', campoValor: 'valor', campoPeriodo: 'periodo', invertido: false, unidade: 'psicologos' }, dataAvailability: 'api_mensal' },
  { medidaId: 'E5.A2', eixo: 5, dataAvailability: 'dados_fixos' },
  { medidaId: 'E5.A3', eixo: 5, dataAvailability: 'dados_fixos' },
  { medidaId: 'E5.B1', eixo: 5, dataAvailability: 'dados_fixos' },
