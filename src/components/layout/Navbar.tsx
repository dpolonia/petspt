        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <Link
              to="/europa"
              className={`px-3 py-1.5 rounded-md text-xs font-medium transition-colors
                ${location.pathname === '/europa' ? 'bg-blue-100 text-blue-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'}`}
            >
              Europa
            </Link>
            <Link
              to="/relatorios"
              className={`px-3 py-1.5 rounded-md text-xs font-medium transition-colors
                ${location.pathname === '/relatorios' ? 'bg-emerald-100 text-emerald-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'}`}
            >
              PDF
            </Link>
            <Link
            ...
            <Link
              to="/metodologia"
              className={`px-3 py-1.5 rounded-md text-xs font-medium transition-colors
                ${location.pathname === '/metodologia' ? 'bg-cyan-100 text-cyan-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'}`}
            >
              Metodologia
            </Link>
            <Link
        ...
        {menuOpen && (
          <div className="md:hidden pb-3 border-t border-gray-100 mt-1 pt-2">
            ...
            <div className="grid grid-cols-2 gap-1 mt-2">
              ...
              <Link to="/europa" onClick={() => setMenuOpen(false)}
                className="px-2 py-2 rounded-md text-xs font-medium text-center text-gray-500 hover:bg-gray-50">
                Europa
              </Link>
              <Link to="/relatorios" onClick={() => setMenuOpen(false)}
                className="px-2 py-2 rounded-md text-xs font-medium text-center text-gray-500 hover:bg-gray-50">
                PDF
              </Link>
