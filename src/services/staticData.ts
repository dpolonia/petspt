...
export const MEDIDAS_ESTADO: MedidaEstado[] = [
  ...
  { id: 'E1.B3', eixo: 1, nome: 'Reforço do acesso à consulta especializada', nomeCurto: 'Consulta Especialidade', estado: 'concluida', prioridade: 'prioritaria', descricaoProgresso: 'Q1 2025: 391.472 consultas CTH (+4% vs. Q1 2024).' },
  ...
  // ─── EIXO 2 ──────────────────────
  { id: 'E2.A1', eixo: 2, nome: 'Criação de canal SNS Grávida', nomeCurto: 'SNS Grávida', estado: 'concluida', prioridade: 'urgente', descricaoProgresso: '133.500 chamadas desde início do PETS. 36.500 grávidas retiradas das urgências.' },
  ...
  { id: 'E3.A2', eixo: 3, nome: 'Centros de Atendimento Clínico', nomeCurto: 'CAC', estado: 'concluida', prioridade: 'urgente', descricaoProgresso: '15 CAC operacionais (vs. 2 iniciais). 30.334 utentes atendidos (Ago/24–Abr/25).' },
  { id: 'E3.A3', eixo: 3, nome: 'Consulta dia seguinte CSP', nomeCurto: 'Consulta Dia Seguinte', estado: 'concluida', prioridade: 'urgente', descricaoProgresso: 'Implementada em 26+ ULS.' },
  { id: 'E3.B1', eixo: 3, nome: 'Libertação de camas', nomeCurto: 'Libertação Camas', estado: 'concluida', prioridade: 'prioritaria', descricaoProgresso: '1.611 camas contratadas ao setor privado e social (vs. 538 em Dez/2024).' },
  ...
  { id: 'E3.B4', eixo: 3, nome: 'Teleconsultas situações menores', nomeCurto: 'Teleconsultas', estado: 'concluida', prioridade: 'prioritaria', descricaoProgresso: '7.000 teleconsultas realizadas em ~4 meses.' },
  ...
  // ─── EIXO 4 ──────────────────────
  { id: 'E4.A1', eixo: 4, nome: 'Atribuição de Médicos de Família', nomeCurto: 'Médicos Família', estado: 'concluida', prioridade: 'urgente', descricaoProgresso: 'Mar/2025: +135.542 cidadãos com MdF vs. Jan/2024. 1,6M utentes ainda sem MdF.' },
  { id: 'E4.A2', eixo: 4, nome: 'Batas Brancas (parceria setor social)', nomeCurto: 'Batas Brancas', estado: 'em_curso', prioridade: 'urgente', descricaoProgresso: '323.674 consultas acumuladas até Dez/2024 (+49,83%). 8 ULS, 22 instituições sociais.' },
  ...
  { id: 'E4.A4', eixo: 4, nome: 'Linha acesso médico no dia', nomeCurto: 'Ligue Antes', estado: 'concluida', prioridade: 'urgente', descricaoProgresso: '2024: 3,5M chamadas. Q1 2025: 1,7M chamadas. Taxa resposta: 87%.' },
  { id: 'E4.B1', eixo: 4, nome: 'USF-modelo C', nomeCurto: 'USF-C', estado: 'em_curso', prioridade: 'prioritaria', descricaoProgresso: '19 candidaturas registadas. Estima-se 191.000 utentes.', legislacao: 'DL 81/2024' },
  { id: 'E4.B2', eixo: 4, nome: 'Médicos aposentados', nomeCurto: 'Médicos Aposentados', estado: 'concluida', prioridade: 'prioritaria', descricaoProgresso: '207 contratados em 2024 + 41 em Q1 2025.' },
  ...
  { id: 'E4.C2', eixo: 4, nome: 'Rastreios oncológicos CSP', nomeCurto: 'Rastreios Oncológicos', estado: 'em_curso', prioridade: 'estruturante', descricaoProgresso: 'Mama: 65,42% (2024). Colo: 59,66%. Colorretal: 58,42%. Tendência de subida.' },
  ...
  // ─── EIXO 5 ──────────────────────
  { id: 'E5.A1', eixo: 5, nome: 'Contratação de psicólogos CSP', nomeCurto: 'Psicólogos CSP', estado: 'concluida', prioridade: 'urgente', descricaoProgresso: '31 novas contratações desde Mai/2024. Total SNS: 1.385. 60 vagas em concurso.' },
  ...
  { id: 'E5.A3', eixo: 5, nome: 'Desinstitucionalização SM', nomeCurto: 'Desinstitucionalização', estado: 'em_curso', prioridade: 'urgente', descricaoProgresso: 'Aviso de abertura publicado em 12/Fev/2025. 500 respostas previstas.' },
  { id: 'E5.B1', eixo: 5, nome: 'Equipas Comunitárias SM (ECSM)', nomeCurto: 'ECSM', estado: 'concluida', prioridade: 'prioritaria', descricaoProgresso: '20 ECSM de 2021-2022 operacionais. Avisos para 20 adicionais publicados.' },
  ...
  { id: 'E5.B4', eixo: 5, nome: 'Serviços regionais SM complexidade', nomeCurto: 'Serviços Regionais SM', estado: 'em_curso', prioridade: 'prioritaria', descricaoProgresso: '8 obras concluídas, 12 em curso.' },
  { id: 'E5.C1', eixo: 5, nome: 'Serviços forenses', nomeCurto: 'Forenses', estado: 'em_curso', prioridade: 'estruturante', descricaoProgresso: 'HMLemos: 20 camas abertas. Sobral Cid e JMatos: estimativa início 2026.' },
  { id: 'E5.C2', eixo: 5, nome: 'CRI em SLSM', nomeCurto: 'CRI', estado: 'concluida', prioridade: 'estruturante', descricaoProgresso: '15 projetos-piloto em funcionamento desde Jul/2024.', legislacao: 'Portaria 73/2024' },
];
